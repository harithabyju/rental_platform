...
async function testAll() {
    ...
    try {
        ...
        result.bookingsByCategory = (await db.query(`
        ...
        result.revenueTrend = (await db.query(`
            SELECT 
        ...
        result.categoryDistribution = (await db.query(`
        ...
        result.topShops = (await db.query(`
            SELECT 
                s.name as shop_name,
                s.city as location,
        ...
        fs.writeFileSync('c:/Users/priya/OneDrive/Desktop/rental_platform/backend/query_output.json', JSON.stringify({ success: true, data: result }));
    } catch (e) {
        fs.writeFileSync('c:/Users/priya/OneDrive/Desktop/rental_platform/backend/query_output.json', JSON.stringify({ success: false, error: e.message, stack: e.stack }));
    } finally {
        process.exit();
    }
}
