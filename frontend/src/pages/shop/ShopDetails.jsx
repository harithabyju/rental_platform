...
const ShopDetails = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto p-6">
            <div className="bg-white dark:bg-[#111827] rounded-lg shadow-sm p-8 mb-8">
                <h1 className="text-4xl font-bold text-gray-900 dark:text-gray-100 mb-4">{shop.shop_name}</h1>
            ...
            {items.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    {items.map(item => (
                        <div key={item.item_id} className="bg-white dark:bg-[#111827] rounded-lg shadow-md hover:shadow-lg transition overflow-hidden">
                            ...
                            <div className="p-4">
                                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-1">{item.item_name}</h3>
